...
This section is for developers and integrators. It explains OpenTalking internals, API
boundaries, and extension points. If the goal is to run the project first, start with
[Tutorials](../tutorials/index.md). If the goal is model serving, start with
