...
| `omnirt` | OmniRT exposes `/v1/audio2video/{model}`. | `wav2lip`, `musetalk`, `flashtalk` |
...
| `reason=omnirt_unavailable` | OmniRT reachability or model registration issue. | Check OmniRT `/health`, model list, and logs. |
